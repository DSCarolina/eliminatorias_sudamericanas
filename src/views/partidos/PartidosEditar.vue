    ...
    <div class="container mt-4">
        ...
        <form  @submit.prevent="emitir($event)" novalidate>
            ...
            <div class="mb-3">
                ...
                <select v-model="itemLocal.estadio" class="form-select" required>
            ...
            <div class="mb-3">
                ...
                <select v-model="itemLocal.localId" class="form-select" required>
                    <option value="">Seleccione</option>
            ...
            <div class="mb-3">
                ...
                <select v-model="itemLocal.visitanteId" class="form-select" required>
                    <option value="">Seleccione</option>
                    <option v-for="(value, index) in seleccionesList" :key="index" :value="value.id">{{ value.nombre }}
                    </option>
                </select>
            ...
            <div class="mb-3">
                ...
                <input v-model="itemLocal.goles_local" type="number" min="0" class="form-control" required />
                <div class="invalid-feedback">El valor es requerido.</div>
            </div>

            <div class="mb-3">
                <label class="form-label">Goles Visitantes *</label>
                <input v-model="itemLocal.goles_visitante" type="number" min="0" class="form-control" required />
                <div class="invalid-feedback">El valor es requerido.</div>
            </div>
