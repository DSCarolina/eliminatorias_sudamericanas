    ...
    <div class="container mt-4">
        ...
        <form @submit.prevent="emitir($event)" novalidate>
            ...
            <div class="mb-3">
                ...
                <select v-model="item.jugadorId" class="form-select" required>
            ...
            <div class="mb-3">
                ...
                <select v-model="item.partidoId" class="form-select" required>
                    <option value="">Seleccione</option>
            ...
            <div class="row">
             <div class="col-md-6 mb-3">
                ...
                <input v-model="item.minutos_jugados" type="number" min="0" class="form-control" required />
                <div class="invalid-feedback">El valor es requerido.</div>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Goles *</label>
                <input v-model="item.goles" type="number" min="0" class="form-control" required />
                <div class="invalid-feedback">El valor es requerido.</div>
            </div>
            </div>
            <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input v-model="item.tarjetas_amarillas" type="number" min="0" class="form-control" required />
                <div class="invalid-feedback">El valor es requerido.</div>
            </div>

            <div class="col-md-6 mb-3">
                <label class="form-label">Tarjetas Rojas *</label>
                <input v-model="item.tarjetas_rojas" type="number" min="0" class="form-control" required />
                <div class="invalid-feedback">El valor es requerido.</div>
            </div>
            </div>
